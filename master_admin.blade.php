...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <li class='list-group-item'><a href="{{url('cate')}}">ADD CATEGORY</a></li>
      <li class='list-group-item'><a href="{{url('subcate')}}">ADD SUBCATEGORY</a></li>
      <li class='list-group-item'><a href="{{url('type')}}">ADD TYPE</a></li>
      <li class='list-group-item'><a href="{{url('addproduct')}}">ADD PRODUCT</a></li>
